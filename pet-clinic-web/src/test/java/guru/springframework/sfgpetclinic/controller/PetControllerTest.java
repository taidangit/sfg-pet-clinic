...
class PetControllerTest {
    ...
    void processCreationForm() throws Exception {
        when(ownerService.findById(anyLong())).thenReturn(Owner.builder().id(1L)
                .build());

        mockMvc.perform(post("/owners/1/pets/save"))
    ...
    @Test
    void displayPet() throws Exception {
        when(petService.findById(anyLong())).thenReturn(Pet.builder().id(1L).build());

        mockMvc.perform(get("/owners/1/pets/123"))
                .andExpect(status().isOk())
                .andExpect(view().name("pet/petDetail"))
